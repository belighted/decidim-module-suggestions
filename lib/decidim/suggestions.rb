...
require "decidim/suggestions/admin"
require "decidim/suggestions/engine"
require "decidim/suggestions/admin_engine"
require "decidim/suggestions/participatory_space"

module Decidim
  # Base module for the suggestions engine.
  module Suggestions
    ...
    # suggestions similar. Defaults to 0.25.
    config_accessor :similarity_threshold do
      0.25
    end

    # Public Setting that defines how many similar suggestions will be shown.
    # Defaults to 5.
    config_accessor :similarity_limit do
      5
    end

    # Minimum number of committee members required to pass the suggestion to
    # technical validation phase. Only applies to suggestions created by
    # individuals.
    config_accessor :minimum_committee_members do
      2
    end

    # Number of days available to collect supports after an suggestion has been
    # published.
    config_accessor :default_signature_time_period_length do
      120
    end

    # Components enabled for a new suggestion
    ...
    # After this time the suggestion will be moved to
    # discarded state.
    ...
    # a printed version of the suggestion from the administration
    # panel.
