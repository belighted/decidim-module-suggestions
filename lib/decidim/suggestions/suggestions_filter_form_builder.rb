...
module Decidim
  module Suggestions
    ...
    # Suggestion types.
    class SuggestionsFilterFormBuilder < Decidim::FilterFormBuilder
      # Public: Generates a select field with the suggestion types.
      #
      # name       - The name of the field (usually type_id)
      # collection - A collection of suggestion types.
      # options    - An optional Hash with options:
      # - prompt   - An optional String with the text to display as prompt.
      #
      # Returns a String.
      def suggestion_types_select(name, collection, options = {})
