  ...
  module Suggestions
    ...
    class SuggestionForm < Form
      ...
      validates :signature_end_date, date: { after: Date.current }, if: lambda { |form|
        form.context.suggestion_type.custom_signature_end_date_enabled? && form.signature_end_date.present?
      }
      ...
      def scope_exists
        ...
        errors.add(:scope_id, :invalid) unless SuggestionsTypeScope.where(decidim_suggestions_types_id: type_id, decidim_scopes_id: scope_id).exists?
      end
