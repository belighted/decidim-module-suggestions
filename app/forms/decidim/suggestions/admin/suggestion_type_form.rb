...
module Decidim
  module Suggestions
    module Admin
      # A form object used to collect the all the suggestion type attributes.
      class SuggestionTypeForm < Decidim::Form
        include TranslatableAttributes

        mimic :suggestions_type
        ...
        validates :banner_image, presence: true, if: ->(form) { form.context.suggestion_type.nil? }
