...
module Decidim
  module Suggestions
    # Custom helpers, scoped to the suggestions engine.
    #
    module ApplicationHelper
      ...
      def filter_states_values
        TreeNode.new(
          TreePoint.new("", t("decidim.suggestions.application_helper.filter_state_values.all")),
          [
            TreePoint.new("open", t("decidim.suggestions.application_helper.filter_state_values.open")),
            TreeNode.new(
              TreePoint.new("closed", t("decidim.suggestions.application_helper.filter_state_values.closed")),
              [
                TreePoint.new("accepted", t("decidim.suggestions.application_helper.filter_state_values.accepted")),
      ...
      def filter_scopes_values
        ...
        TreeNode.new(
          TreePoint.new("", t("decidim.suggestions.application_helper.filter_scope_values.all")),
          scopes_values
        )
      end
      ...
      def filter_types_values
        types_values = Decidim::SuggestionsType.where(organization: current_organization).map do |type|
          TreeNode.new(
        ...
        TreeNode.new(
          TreePoint.new("", t("decidim.suggestions.application_helper.filter_type_values.all")),
          types_values
        )
      end
      ...
      def filter_areas_values
        ...
        TreeNode.new(
          TreePoint.new("", t("decidim.suggestions.application_helper.filter_area_values.all")),
          areas_values
        )
      end
